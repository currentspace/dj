...
While the new OpenAPI routes are much better, they still have validation gaps. The legacy routes and services have severe type safety issues with extensive use of `any` and missing Zod validation.
