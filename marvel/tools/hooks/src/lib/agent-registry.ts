...
export function completeAgent(sessionId: string, agentId: string, transcriptPath?: string, context?: LogContext): void {
...
export function errorAgent(sessionId: string, agentId: string, errorMessage: string, context?: LogContext): void {
  const sessionAgents = agentsBySession.get(sessionId)
  if (!sessionAgents) return
...
export function registerAgent(sessionId: string, agentId: string, agentType: string, context?: LogContext): void {
  startCleanupTimer()
...
export function trackTeammate(sessionId: string, teammateName: string, teamName: string, context?: LogContext): void {
