 ...
 */
export function invalidatePreCommitChecks(checks: PreCommitCheckType[], context?: LogContext): void {
  const state = loadSessionState(context)
 ...
 */
export function recordPreCommitSuccess(command: string, context?: LogContext): null | PreCommitCheckType {
