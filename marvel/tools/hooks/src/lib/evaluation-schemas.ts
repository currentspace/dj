 ...
 */
export function isValidSecurityDecision(value: unknown): value is AgentSecurityDecision {
  ...
  if (obj.suggested_rule !== undefined) {
    if (obj.suggested_rule === null || typeof obj.suggested_rule !== 'object') return false
...
export const META_EVALUATION_SCHEMA: Record<string, unknown> = {
  ...
  required: ['original_decision', 'correct', 'suggested_decision', 'reasoning', 'confidence'],
  type: 'object',
}
