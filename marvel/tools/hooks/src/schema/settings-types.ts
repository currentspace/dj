...
export type NotificationMatcher = 'auth_success' | 'elicitation_dialog' | 'idle_prompt' | 'permission_prompt'
...
export type SessionEndMatcher = 'bypass_permissions_disabled' | 'clear' | 'logout' | 'other' | 'prompt_input_exit'
...
// Valid handler types
export const VALID_HANDLER_TYPES: readonly HookHandlerType[] = ['command', 'prompt', 'agent'] as const
