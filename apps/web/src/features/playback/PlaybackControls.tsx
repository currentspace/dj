...
export function PlaybackControls({isPlaying, onPlaybackChange, supportsVolume, volumePercent}: PlaybackControlsProps) {
    ...
    <div className={styles.controls}>
      ...
      {supportsVolume && (
        <div className={styles.volumeControl}>
          <svg className={styles.volumeIcon} fill="currentColor" height="18" viewBox="0 0 24 24" width="18">
            {localVolume === 0 ? (
